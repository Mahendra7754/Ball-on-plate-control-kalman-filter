...
*                 mys 161207 added _aux_getch(), _aux_putch() [ _aux_keyhit() ]
*********************************************************************************************************
*/
...
void           BSP_SetLED( const unsigned char LED_bitpattern );
void           BSP_TurnOnOffLED ( const unsigned char LED_bit, const unsigned char on );

void           BSP_SetEXTIPR( unsigned int EXTI_bitpattern );
unsigned int   BSP_GetEXTIPR( void );


/************************************************************************\
*    Low-level single character IO via CONSOLE serial port = stdin/stdout 
\************************************************************************/

char         _putch (char c);      // send char to console  161207 changed param int -> char
char         _getch (void);        // read char from console
char         _keyhit(void);        // 0 if no input, else key code from console


/************************************************************************\
*    Low-level single character IO via AUX serial port
\************************************************************************/

char         _aux_putch (char c);  // send char to AUX serial port
char         _aux_getch (void);    // read char from AUX serial port
//char       _aux_keyhit(void);    // 0 if no input, else char from AUX serial port
