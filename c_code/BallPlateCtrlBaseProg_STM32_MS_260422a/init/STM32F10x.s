...
;/*****************************************************************************/
;/* 08.03.2017  mys   Increased stacksize from 0x200 to 0x300                 */
;/* 13.03.2017  mys   Added get_pc_from_intstack PROC to be called from       */
;/*                   hi-level custom HardFault_Handler()                     */
;/*****************************************************************************/
...
get_pc_from_intstack PROC
                EXPORT  get_pc_from_intstack
;--------------------------------------------------------------------------
; brief:				Read PC value from interrupt-stackframe
;
; C-Prototype:			UINT 	get_pc_from_intstack (void);
; Uses Register:		R0
;                                                                     
; 24.11.2009	mys     Initial version                                            
;--------------------------------------------------------------------------

		LDR		R0, [SP, #6*4]		; original PC stacked 6 regs above SP
		BX		LR					; return
		ENDP
